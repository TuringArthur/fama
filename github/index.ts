...
function useShareUrl() {
  return isMock() ? "https://dev.fama.ai" : "https://fama.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.fama.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.fama.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
