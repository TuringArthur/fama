...
const releaseId = process.env.FAMA_RELEASE
if (!releaseId) throw new Error("FAMA_RELEASE is required")

const version = process.env.FAMA_VERSION
if (!version) throw new Error("FAMA_VERSION is required")
