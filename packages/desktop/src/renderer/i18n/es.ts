export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Fama",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Fama. ¿Quieres instalarla y reiniciar?",
