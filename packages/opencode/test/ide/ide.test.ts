...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders FAMA_CALLER", () => {
    process.env["FAMA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode FAMA_CALLER", () => {
    process.env["FAMA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown FAMA_CALLER", () => {
    process.env["FAMA_CALLER"] = "unknown"
