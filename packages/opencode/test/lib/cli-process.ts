...
//   - FAMA_CONFIG_CONTENT      : provider config inline, no files to find
//   - FAMA_TEST_HOME           : pins os.homedir() → tmpdir
//   - FAMA_DISABLE_PROJECT_CONFIG : skip walking up for opencode.json
//   - FAMA_PURE                : skip external plugin discovery + install
//   - FAMA_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    FAMA_CONFIG_CONTENT: configJson,
    FAMA_DISABLE_PROJECT_CONFIG: "1",
    FAMA_PURE: "1",
    FAMA_DISABLE_AUTOUPDATE: "1",
    FAMA_DISABLE_AUTOCOMPACT: "1",
    FAMA_DISABLE_MODELS_FETCH: "1",
    FAMA_AUTH_CONTENT: "{}",
  }
}
