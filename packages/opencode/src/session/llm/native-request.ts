import type { JsonSchema, LLMRequest, ProviderMetadata } from "@fama-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@fama-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @fama-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
