...
import { llmClient } from "@fama-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@fama-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@fama-ai/llm/route"
import type { LLMClientService } from "@fama-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@fama/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @fama-ai/llm. It
