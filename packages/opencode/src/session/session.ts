...
import { PartTable, SessionTable } from "@fama-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@fama-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".fama", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@fama/Session") {}
