...
import type * as SDK from "@fama-ai/sdk/v2"
...
import { SessionShareTable } from "@fama-ai/core/share/sql"
import { ProviderV2 } from "@fama-ai/core/provider"
import { ModelV2 } from "@fama-ai/core/model"
import { EventV2 } from "@fama-ai/core/event"

const disabled = process.env["FAMA_DISABLE_SHARE"] === "true" || process.env["FAMA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@fama/ShareNext") {}
