...
import { optionalOmitUndefined } from "@fama-ai/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@fama-ai/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
...
export class Service extends Context.Service<Service, Interface>()("@fama/Provider") {}
