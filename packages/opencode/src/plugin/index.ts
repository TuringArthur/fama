...
import { createOpencodeClient } from "@fama-ai/sdk"
...
import { InstallationChannel } from "@fama-ai/core/installation/version"
...
export class Service extends Context.Service<Service, Interface>()("@fama/Plugin") {}
