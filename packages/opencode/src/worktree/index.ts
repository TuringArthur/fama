...
import { path } from "@fama-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@fama-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@fama/Worktree") {}
