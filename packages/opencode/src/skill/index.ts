...
import { FrontmatterError } from "@fama-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@fama-ai/core/util/glob"
...
// when the model is asked to touch fama's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_FAMA_SKILL_NAME = "customize-fama"
const CUSTOMIZE_FAMA_SKILL_DESCRIPTION =
...
const CUSTOMIZE_FAMA_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_FAMA_SKILL_NAME] = {
          name: CUSTOMIZE_FAMA_SKILL_NAME,
          description: CUSTOMIZE_FAMA_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_FAMA_SKILL_BODY,
        }
