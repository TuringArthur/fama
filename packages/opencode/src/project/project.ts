...
import { ProjectDirectoryTable, ProjectTable } from "@fama-ai/core/project/sql"
import { ProjectDirectories } from "@fama-ai/core/project/directories"
...
import { which } from "@fama-ai/core/util/which"
...
import { CrossSpawnSpawner } from "@fama-ai/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@fama-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@fama/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.FAMA_FAKE_VCS)
