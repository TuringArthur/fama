...
import type { Event, GlobalEvent, OpencodeClient } from "@fama-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@fama/RunStreamTransport") {}
