 ...
 *   "@fama/ServerAuthConfig",
 *   {
 *     password: Config.string("FAMA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("FAMA_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
