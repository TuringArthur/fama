...
import type { Message, OpencodeClient, SessionMessageResponse } from "@fama-ai/sdk/v2"
...
export class Service extends Context.Service<Service, Interface>()("@fama/ACP/Service") {}
