...
export const TypeId: TypeId = "~@fama-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@fama-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@fama-ai/effect-sqlite-node/NodeSqliteClient")
