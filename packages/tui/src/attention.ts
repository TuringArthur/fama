...
import defaultSoundPath from "@fama-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@fama-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@fama-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@fama-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@fama-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@fama-ai/ui/audio/yup-01.mp3" with { type: "file" }
