...
import { createOpencodeClient } from "@fama-ai/sdk/v2/client"
import { ServerAuth } from "@fama-ai/server/auth"
...
export class Service extends Context.Service<Service, Interface>()("@fama/cli/Daemon") {}
