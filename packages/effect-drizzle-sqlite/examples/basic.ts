...
class Database extends Context.Service<Database, DatabaseShape>()("@fama/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@fama/example/UserStore") {
