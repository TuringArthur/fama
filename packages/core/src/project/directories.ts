...
import type { EffectDrizzleSqlite } from "@fama-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@fama/ProjectDirectories") {}
