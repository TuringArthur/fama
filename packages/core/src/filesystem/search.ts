...
export class Service extends Context.Service<Service, Interface>()("@fama/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.FAMA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
