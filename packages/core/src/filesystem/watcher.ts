...
declare const FAMA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof FAMA_LIBC === "undefined" ? undefined : FAMA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@fama/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.FAMA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.FAMA_EXPERIMENTAL_FILEWATCHER) {
