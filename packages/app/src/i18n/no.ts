...
export const dict = {
  ...
  "dialog.provider.fama.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.fama.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.famaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Fama",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Fama.",
  ...
  "provider.connect.famaZen.line1":
    "Fama Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.famaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.famaZen.visit.prefix": "Besøk ",
  "provider.connect.famaZen.visit.link": "fama.ai/zen",
  "provider.connect.famaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Fama.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Fama.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i fama.json",
  ...
  "dialog.server.description": "Bytt hvilken Fama-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Fama ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Fama-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (fama.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Fama ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Fama inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Fama-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Fama",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Fama ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Fama skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Fama er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Fama starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Fama.",
