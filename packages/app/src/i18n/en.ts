export const dict = {
  ...
  "command.redact.open": "Redact case (脱密) (beta)",
  "sidebar.redact": "Redact case",
  "redact.title": "Case Redaction (案件脱密) (beta)",
  "redact.beta": "beta",
  "redact.beta.disclaimer":
    "This is a beta feature: it uses local rule-based matching, optimized for recall rather than zero false positives. Redaction is an aid — always review the redacted copy manually before sharing it.",
  "redact.description":
    "Generate a desensitized copy of your case materials: names, ID numbers, phone numbers, bank cards, addresses and secret markers are replaced with stable placeholders, so it can be safely uploaded to an AI platform.",
  "redact.action.pickFile": "Choose file…",
  "redact.action.pickFiles": "Choose multiple files…",
  "redact.action.run": "Run redaction",
  "redact.action.runAll": "Redact all",
  "redact.action.copy": "Copy redacted text",
  "redact.action.save": "Save redacted copy",
  "redact.action.saveAll": "Save all to folder…",
  "redact.action.saveMap": "Save mapping table",
  "redact.action.reset": "Start over",
  "redact.mode.single": "Single / text",
  "redact.mode.batch": "Batch files",
  "redact.mode.restore": "Un-redact",
  "redact.drop.hint": "Drop files to upload",
  "redact.drop.badge": "Drag-and-drop supported · .txt/.md/.docx/.doc",
  "redact.action.addRule": "Add custom rule",
  "redact.action.removeRule": "Remove",
  "redact.input.placeholder": "Paste case text here, or pick a .txt/.md/.docx file…",
  "redact.input.hint": "Runs locally; nothing is uploaded. Always review before sharing.",
  "redact.picker.open": "Choose a case file",
  "redact.picker.openMultiple": "Choose case files (multi-select)",
  "redact.picker.save": "Save redacted copy",
  "redact.picker.saveMap": "Save mapping table",
  "redact.picker.saveDir": "Choose an output folder",
  "redact.summary": "Found {{findings}} sensitive items across {{mapping}} distinct entities.",
  "redact.scope.warning": "This document involves:",
  "redact.scope.nationalSecret": "National secret",
  "redact.scope.commercialSecret": "Commercial secret",
  "redact.scope.personalPrivacy": "Personal privacy",
  "redact.preview.label": "Preview",
  "redact.preview.original": "Original",
  "redact.preview.redacted": "Redacted",
  "redact.mapping.label": "Placeholder mapping ({{count}})",
  "redact.mapping.token": "Placeholder",
  "redact.mapping.category": "Category",
  "redact.mapping.value": "Original value",
  "redact.mapping.warning":
    "This mapping is sensitive — keep it locally and never upload it together with the redacted copy.",
  "redact.save.desktopOnly": "Saving to disk is available in the desktop app.",
  "redact.savedAt": "Saved to: {{path}}",
  "redact.toast.copied": "Redacted text copied",
  "redact.toast.saved": "Redacted copy saved",
  "redact.toast.mapSaved": "Mapping table saved",
  "redact.toast.batchSaved": "Redacted and saved {{count}} files",
  "redact.toast.batchEmpty": "No files to redact",
  "redact.format.label": "Supported formats",
  "redact.format.text": "Plain text / Markdown: .txt .md (read directly)",
  "redact.format.docx": "Word: .docx (structured extraction, high fidelity)",
  "redact.format.doc": "Word: .doc (legacy binary, best-effort extraction, low fidelity — convert to .docx)",
  "redact.review.title": "Please review manually before uploading",
  "redact.review.body":
    "Automatic redaction cannot cover semantic sensitive information (e.g. project codenames, entities not in the dictionary, implicit relationships). Review the redacted copy section by section and confirm nothing is missed before sharing or uploading to an AI platform.",
  "redact.review.stageTitle": "Review detected items",
  "redact.review.stageHint": "Remove any item you don't want redacted (false positives, e.g. 'dismissed XX Inc.' read as a company name). After confirming, the redacted copy is generated from the kept items.",
  "redact.review.confirm": "Confirm redaction",
  "redact.review.back": "Back to editing",
  "redact.review.delete": "Remove",
  "redact.review.add": "Add entry",
  "redact.review.fromRule": "From a custom rule; category locked",
  "redact.review.value": "Matched text",
  "redact.review.empty": "Nothing to redact (the relevant categories may all be unchecked).",
  "redact.custom.title": "Customize what to redact",
  "redact.custom.hint": "Toggle built-in categories, and add custom rules for entities they miss (e.g. a company, a codename). Matches are replaced with [NameN] placeholders.",
  "redact.custom.categories": "Categories",
  "redact.custom.rules": "Custom rules",
  "redact.custom.ruleName": "Name (used in placeholder)",
  "redact.custom.rulePattern": "Regex or literal text",
  "redact.custom.ruleFlags": "Flags (optional, defaults to i)",
  "redact.batch.title": "Batch redaction",
  "redact.batch.empty": "No files selected yet.",
  "redact.batch.count": "{{count}} files selected",
  "redact.batch.status": "Pending",
  "redact.batch.fidelityLow": "low fidelity",
  "redact.restore.title": "Un-redact (restore placeholders)",
  "redact.restore.hint": "Swap placeholders like [Name1] in redacted text back to their real values using the mapping table. Paste or pick the AI-processed text, then restore.",
  "redact.restore.map.source": "Mapping source",
  "redact.restore.map.session": "Use this session's mapping ({{count}})",
  "redact.restore.map.import": "Import a mapping file…",
  "redact.restore.map.loaded": "Mapping loaded ({{count}} entries)",
  "redact.restore.map.bad": "Mapping not recognized: pick a .json exported by this tool (or a legacy .md table)",
  "redact.restore.action.pickMap": "Choose mapping file…",
  "redact.restore.action.pickInput": "Choose file to restore…",
  "redact.restore.action.run": "Un-redact",
  "redact.restore.action.copy": "Copy restored text",
  "redact.restore.action.save": "Save restored copy",
  "redact.restore.input.placeholder": "Paste AI-processed text (with [Name1] placeholders), or pick a .txt/.md/.docx file…",
  "redact.restore.empty.map": "Pick or import a mapping first",
  "redact.restore.preview.label": "Restored result",
  "redact.restore.picker.input": "Choose file to restore",
  "redact.restore.picker.map": "Choose mapping file",
  "redact.restore.picker.save": "Save restored copy",
  "redact.restore.toast.noTokens": "No placeholders found in the text; nothing to restore",
  "redact.restore.toast.copied": "Restored text copied",
  "redact.restore.toast.saved": "Restored copy saved",
  "redact.info.title": "How it works & limitations",
  "redact.info.principle":
    "How it works: runs entirely on your device. Built-in regexes and heuristics scan the text for ID numbers, phone numbers, bank cards, emails, license plates, addresses, contextual names, enterprise names and secret markers, then replace each distinct sensitive value with a stable placeholder (e.g. [Name1]) so document structure and readability are preserved for the AI.",
  "redact.info.coverage":
    "Typically redactable: ID numbers, mobile/landline numbers, bank card numbers, emails, license plates, addresses, contextual names (e.g. 'Plaintiff: Zhang San'), enterprise/institution names, secret/classification markers, and anything your custom rules match.",
  "redact.info.limitations":
    "Limitations: (1) rule/heuristic matching — false negatives and positives occur; (2) no semantic understanding — cannot detect entities absent from the dictionary, implicit relationships, or context-only secrets; (3) legacy .doc is best-effort only; (4) text only — cannot handle images/scans. Manual review after redaction is therefore mandatory.",
  ...
  "dialog.provider.fama.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.fama.tagline": "Reliable optimized models",
  "dialog.provider.famaGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Fama",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Fama.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.famaZen.line1":
    "Fama Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.famaZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.famaZen.visit.prefix": "Visit ",
  "provider.connect.famaZen.visit.link": "fama.ai/zen",
  "provider.connect.famaZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Fama.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Fama.",
  ...
  "dialog.plugins.empty": "Plugins configured in fama.json",
  ...
  "dialog.server.description": "Switch which Fama server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Fama...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Fama in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Fama...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Fama in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Fama in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Fama",
  "wsl.onboarding.famaReadyIn": "Fama is ready in {{distro}}.",
  "wsl.onboarding.famaReady": "Fama is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Fama in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Fama",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Fama.",
  ...
  "toast.update.description": "A new version of Fama ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Fama team",
  ...
  "error.chain.checkConfig": "Check your config (fama.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Fama does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Fama includes free models so you can start immediately.",
  ...
  "settings.about.description": "About Fama",
  "settings.about.descriptionText": "Fama is an intelligent legal assistant designed for legal professionals. Powered by advanced large language model technology, Fama helps lawyers, judges, and other legal practitioners efficiently handle legal documents, answer legal questions, and conduct legal research.",
  "settings.about.features": "Core Features",
  "settings.about.feature1": "Smart Legal Document Generation - 54 legal document templates",
  "settings.about.feature2": "Legal Knowledge Q&A - Covering criminal, civil, commercial law and more",
  "settings.about.feature3": "Legal Code Search - Built-in comprehensive legal database",
  "settings.about.feature4": "Data Security - Automatic sensitive information masking",
  "settings.about.contact": "Contact Us",
  "settings.about.website": "Website",
  "settings.about.email": "Email",
  "settings.about.copyright": "© 2024-2026 Fama Technology. All rights reserved.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the Fama server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Fama",
  ...
  "settings.general.row.appearance.description": "Customise how Fama looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Fama follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Fama is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Fama launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Fama.",
  ...
  "menu.reloadWebview": "Reload Webview",
  "menu.restart": "Restart",
  "menu.documentation": "Fama Documentation",
  "menu.supportForum": "Support Forum",
