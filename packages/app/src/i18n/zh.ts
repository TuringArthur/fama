...
export const dict = {
  ...
  "command.redact.open": "案件脱密（beta）",
  "sidebar.redact": "案件脱密",
  "redact.title": "案件脱密（beta）",
  "redact.beta": "beta",
  "redact.beta.disclaimer":
    "本功能为测试版：采用本地规则匹配，追求高召回而非零误报。脱密仅为辅助，正式对外分享前请务必人工复核脱密副本。",
  "redact.description":
    "把案件材料生成一套「脱密副本」：姓名、身份证号、手机号、银行卡号、地址、企业名称与涉密标记等会被替换为占位符，可安全上传到 AI 平台协同处理。",
  "redact.action.pickFile": "选择文件…",
  "redact.action.pickFiles": "选择多个文件…",
  "redact.action.run": "开始脱密",
  "redact.action.runAll": "全部脱密",
  "redact.action.copy": "复制脱密文本",
  "redact.action.save": "保存脱密副本",
  "redact.action.saveAll": "全部保存到目录…",
  "redact.action.saveMap": "保存对照表",
  "redact.action.reset": "重新开始",
  "redact.mode.single": "单文件 / 文本",
  "redact.mode.batch": "批量文件",
  "redact.mode.restore": "解除脱密",
  "redact.drop.hint": "松开以拖拽上传文件",
  "redact.drop.badge": "支持拖拽上传 · .txt/.md/.docx/.doc",
  "redact.action.addRule": "新增自定义规则",
  "redact.action.removeRule": "移除",
  "redact.input.placeholder": "在此粘贴案件文本，或选择 .txt/.md/.docx 文件…",
  "redact.input.hint": "全部本地处理，不上传任何内容；分享前请人工复核。",
  "redact.picker.open": "选择案件文件",
  "redact.picker.openMultiple": "选择案件文件（可多选）",
  "redact.picker.save": "保存脱密副本",
  "redact.picker.saveMap": "保存对照表",
  "redact.picker.saveDir": "选择保存目录",
  "redact.summary": "共发现 {{findings}} 处敏感信息，覆盖 {{mapping}} 个不同主体/信息。",
  "redact.scope.warning": "本文档涉及：",
  "redact.scope.nationalSecret": "国家秘密",
  "redact.scope.commercialSecret": "商业秘密",
  "redact.scope.personalPrivacy": "个人隐私",
  "redact.preview.label": "预览",
  "redact.preview.original": "原文",
  "redact.preview.redacted": "脱密后",
  "redact.mapping.label": "占位对照表（{{count}}）",
  "redact.mapping.token": "占位符",
  "redact.mapping.category": "类别",
  "redact.mapping.value": "原始值",
  "redact.mapping.warning": "本表记录脱密前后的对应关系，属敏感信息，请妥善保管，切勿随脱密副本一起上传。",
  "redact.save.desktopOnly": "写入磁盘仅桌面端可用。",
  "redact.savedAt": "已保存至：{{path}}",
  "redact.toast.copied": "脱密文本已复制",
  "redact.toast.saved": "脱密副本已保存",
  "redact.toast.mapSaved": "对照表已保存",
  "redact.toast.batchSaved": "已脱密并保存 {{count}} 个文件",
  "redact.toast.batchEmpty": "没有可脱密的文件",
  "redact.format.label": "支持格式",
  "redact.format.text": "纯文本/Markdown：.txt .md（直接读取）",
  "redact.format.docx": "Word：.docx（结构化抽取，高保真）",
  "redact.format.doc": "Word：.doc（旧二进制，最大努力抽取，低保真，建议另存为 .docx）",
  "redact.review.title": "上传前请人工复核",
  "redact.review.body":
    "自动脱密无法覆盖语义层面的敏感信息（如特定项目代号、未在词典中的实体、隐含的人物关系）。请逐段核对脱密副本，确认无遗漏后再对外分享或上传到 AI 平台。",
  "redact.review.stageTitle": "核对脱密命中",
  "redact.review.stageHint": "删除不想脱密的命中（误报，例如把「驳回XX公司」识别为公司名称），确认后将据此生成脱密副本。",
  "redact.review.confirm": "确认脱密",
  "redact.review.back": "返回编辑",
  "redact.review.delete": "删除",
  "redact.review.add": "新增一条",
  "redact.review.fromRule": "来自自定义规则，类别不可改",
  "redact.review.value": "命中内容",
  "redact.review.empty": "没有可脱密的命中（可能相关类别都未勾选）。",
  "redact.custom.title": "自定义脱密内容",
  "redact.custom.hint": "勾选内置类别；并用自定义规则补充内置覆盖不到的实体（如公司、代号），命中后会被替换为 [名称N] 占位符。",
  "redact.custom.categories": "脱敏类别",
  "redact.custom.rules": "自定义规则",
  "redact.custom.ruleName": "名称（用于占位符）",
  "redact.custom.rulePattern": "正则或文本",
  "redact.custom.ruleFlags": "标志（可选，默认 i）",
  "redact.batch.title": "批量脱密",
  "redact.batch.empty": "尚未选择文件。",
  "redact.batch.count": "已选 {{count}} 个文件",
  "redact.batch.status": "待处理",
  "redact.batch.fidelityLow": "低保真",
  "redact.restore.title": "解除脱密（还原占位符）",
  "redact.restore.hint": "把脱密后文本里的 [姓名1] 等占位符，按对照表换回真实值。AI 处理后的结果可粘贴或选文件后还原。",
  "redact.restore.map.source": "对照表来源",
  "redact.restore.map.session": "使用本次脱密对照表（{{count}} 条）",
  "redact.restore.map.import": "从对照表文件导入…",
  "redact.restore.map.loaded": "已加载对照表（{{count}} 条）",
  "redact.restore.map.bad": "对照表无法识别：请选择由本工具导出的 .json（或旧版 .md 表格）",
  "redact.restore.action.pickMap": "选择对照表文件…",
  "redact.restore.action.pickInput": "选择待还原文件…",
  "redact.restore.action.run": "解除脱密",
  "redact.restore.action.copy": "复制还原文本",
  "redact.restore.action.save": "保存还原副本",
  "redact.restore.input.placeholder": "粘贴 AI 处理后的文本（含 [姓名1] 等占位符），或选择 .txt/.md/.docx 文件…",
  "redact.restore.empty.map": "请先选择/导入对照表",
  "redact.restore.preview.label": "还原结果",
  "redact.restore.picker.input": "选择待还原文件",
  "redact.restore.picker.map": "选择对照表文件",
  "redact.restore.picker.save": "保存还原副本",
  "redact.restore.toast.noTokens": "未在内容中找到占位符，无需解除脱密",
  "redact.restore.toast.copied": "还原文本已复制",
  "redact.restore.toast.saved": "还原副本已保存",
  "redact.info.title": "工作原理与局限性",
  "redact.info.principle":
    "原理：完全在本地（你的设备）运行，按内置正则与启发式规则扫描文本，识别身份证号、手机号、银行卡号、邮箱、车牌号、地址、上下文姓名、企业名称与涉密标记等，再把每个不同的敏感值替换为稳定占位符（如 [姓名1]），保留文档结构与可读性，便于 AI 理解上下文。",
  "redact.info.coverage":
    "一般可脱密的信息：身份证号、手机号、固定电话、银行卡号、邮箱、车牌号、住址/地址、上下文姓名（如「原告：张三」）、企业/机构名称、涉密/密级标记，以及你自定义规则命中的内容。",
  "redact.info.limitations":
    "局限性：① 属规则/启发式匹配，存在漏报与误报；② 无法理解语义，识别不了未在词典中的实体、隐含人物关系或上下文才能判断的敏感信息；③ 旧 .doc 仅做最大努力抽取；④ 仅处理文本，不处理图片/扫描件中的信息。因此脱密后必须人工复核。",
  ...
  "dialog.provider.fama.note": "使用 Fama Zen 或 API 密钥连接",
  "dialog.provider.fama.tagline": "可靠的优化模型",
  "dialog.provider.famaGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Fama 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Fama 中使用 {{provider}} 模型。",
  ...
  "provider.connect.famaZen.line1": "Fama Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.famaZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.famaZen.visit.prefix": "访问 ",
  "provider.connect.famaZen.visit.link": "fama.ai/zen",
  "provider.connect.famaZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Fama 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Fama 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 fama.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Fama 服务器。",
  ...
  "toast.update.description": "Fama 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Fama 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (fama.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Fama 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Fama 提供免费模型，你可以立即开始使用。",
  ...
  "settings.about.description": "关于法码",
  "settings.about.descriptionText": "法码是一款专为法律专业人士打造的智能法律助手。基于先进的大语言模型技术，法码能够帮助律师、法官等法律工作者高效处理法律文书、解答法律问题、进行法律研究，是法律共同体的得力助手。",
  "settings.about.features": "核心功能",
  "settings.about.feature1": "智能法律文书生成 - 支持54种法律文书模板",
  "settings.about.feature2": "法律知识问答 - 覆盖刑法、民法、商事法等领域",
  "settings.about.feature3": "法律条文检索 - 内置完整法律法规数据库",
  "settings.about.feature4": "数据安全保障 - 敏感信息自动脱敏处理",
  "settings.about.contact": "联系我们",
  "settings.about.website": "官网",
  "settings.about.email": "邮箱",
  "settings.about.copyright": "© 2024-2026 法码科技. 保留所有权利.",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 集成",
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Fama 服务器。",
  ...
  "settings.general.row.language.description": "更改 Fama 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 Fama 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Fama 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Fama 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Fama 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Fama。",
  ...
  "session.child.promptDisabled": "子智能体会话无法接收提问。",
  ...
  "wsl.onboarding.pickDistro": "选择一个发行版或在下方安装。",
  "wsl.onboarding.checkingOpencode": "正在检查法码...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的法码...",
  "wsl.onboarding.updatingOpencode": "正在更新法码...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的法码...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的法码。",
  "wsl.onboarding.updateOpencode": "更新法码",
  "wsl.onboarding.famaReadyIn": "法码已在 {{distro}} 中就绪。",
  "wsl.onboarding.famaReady": "法码已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装法码。",
  "wsl.onboarding.installOpencode": "安装法码",
  ...
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开法码。",
  ...
  "settings.general.row.showSearch.description": "在标题栏显示搜索和命令面板按钮",
  ...
  "settings.general.row.newLayoutDesigns.title": "新版布局与设计",
  "settings.general.row.newLayoutDesigns.description": "启用重新设计的布局、主页、输入框和会话界面",
  "settings.general.row.pinchZoom.title": "双指缩放",
  "settings.general.row.pinchZoom.description": "允许触控板双指捏合和 Ctrl 滚动手势进行缩放",
  ...
  "menu.reloadWebview": "重新加载 Webview",
  "menu.restart": "重启",
  "menu.documentation": "法码文档",
  "menu.supportForum": "官网与支持",
  "menu.shareFeedback": "分享反馈",
  "menu.reportBug": "报告问题",
