...
export const dict = {
  ...
  "dialog.onboarding.title": "欢迎使用法码",
  "dialog.onboarding.description": "面向律师、法务与法律专业人士的 AI 法律助手。选择你的角色以定制体验——之后可随时更改。",
  "dialog.onboarding.role.lawyer": "律师",
  "dialog.onboarding.role.counsel": "企业法务",
  "dialog.onboarding.role.judge": "法官",
  "dialog.onboarding.role.prosecutor": "检察官",
  "dialog.onboarding.role.student": "学生 / 教研",
  "dialog.onboarding.role.developer": "开发者",
  "dialog.onboarding.action.bindKey": "绑定 API Key",
  "dialog.onboarding.action.zen": "登录 opencode Zen / Go 账号",
  "dialog.onboarding.action.later": "稍后配置模型",
