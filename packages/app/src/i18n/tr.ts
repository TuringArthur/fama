...
export const dict = {
  ...
  "dialog.provider.fama.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.fama.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.famaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Fama tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Fama'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.famaZen.line1":
    "Fama Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.famaZen.visit.prefix": "",
  "provider.connect.famaZen.visit.link": "fama.ai/zen",
  "provider.connect.famaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Fama'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Fama'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler fama.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Fama sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Fama'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Fama ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (fama.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Fama henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Fama ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Fama Masaüstü",
  ...
  "settings.desktop.wsl.description": "Fama sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Fama'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Fama'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Fama'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Fama'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Fama başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Fama'un en son sürümünü kullanıyorsunuz.",
