...
beforeAll(async () => {
  ...
  mock.module("@fama-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@fama-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@fama-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@fama-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
