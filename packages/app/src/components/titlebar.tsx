...
import { Tooltip, TooltipKeybind } from "@fama-ai/ui/tooltip"
import { useTheme } from "@fama-ai/ui/theme/context"
import { IconButtonV2 } from "@fama-ai/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@fama-ai/ui/v2/icon"
import { KeybindV2 } from "@fama-ai/ui/v2/keybind-v2"
import { TooltipV2 } from "@fama-ai/ui/v2/tooltip-v2"
...
import { ProjectAvatar } from "@fama-ai/ui/v2/project-avatar-v2"
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_FAMA_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_FAMA_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
