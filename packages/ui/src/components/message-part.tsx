...
import { getDirectory as _getDirectory, getFilename } from "@fama-ai/core/util/path"
...
PART_MAPPING["text"] = function TextPartDisplay(props) {
  ...
  return (
    <Show when={text()}>
      <div data-component="text-part" data-role={props.message.role} data-timeline-part-id={part().id}>
